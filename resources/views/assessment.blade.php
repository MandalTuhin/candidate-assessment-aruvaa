            ...
            <form action="{{ route('test.submit') }}" method="POST" id="assessmentForm">
                ...
                <template x-for="(question, index) in questions" :key="question.id">
                    ...
                    >
                        ...
                        <div class="mt-3 sm:mt-4 flex justify-end" x-show="question.selectedAnswer">
                            <button
                                type="button"
                ...
                <div class="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-3 sm:gap-0 mt-6 sm:mt-8 pt-4 sm:pt-6 border-t">
                    ...
                    >
                        ...
                        <svg x-show="!isLoading" class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                        </svg>
                        <span class="text-sm sm:text-base" x-text="isLoading ? 'Loading...' : 'Previous'"></span>
                    </button>
                    ...
                    >
                        ...
                        <span class="text-sm sm:text-base" x-text="isSubmitting ? 'Submitting...' : 'Submit Test'"></span>
                    </button>
                    ...
                    >
                        <span class="text-sm sm:text-base" x-text="isLoading ? 'Loading...' : 'Next'"></span>
                        <svg x-show="!isLoading" class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
