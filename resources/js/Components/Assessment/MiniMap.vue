<template>
  <div class="mb-4 sm:mb-6 bg-gray-50 border border-gray-200 rounded-lg">
    <button 
      ...
      class="flex justify-between items-center w-full p-3 sm:p-4 sm:pb-3 sm:cursor-default sm:pointer-events-none mb-3"
    >
      ...
      <div class="grid grid-cols-5 sm:grid-cols-10 gap-2">
        <button
          ...
          :class="{
            ...
            'bg-green-500 text-white': currentIndex !== index && question.selectedAnswer,
            'bg-gray-200 text-gray-600 hover:bg-gray-300': currentIndex !== index && !question.selectedAnswer
          }"
